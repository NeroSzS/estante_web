<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/estante_web/models/usuario.php';
...
$usuario->email = $email;
$usuario->senha = $senha;
$usuario->foto_perfil = file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/estante_web/imgs/perfil_icon.svg');
