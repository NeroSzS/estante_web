...
<main id="conteudo-livros">
  <div id="modal-livros">
    <div id="btn-livros">
      <h1>Editar Livros</h1>
      <a class="btn-back" href="/estante_web/views/livros.php"><img src="/estante_web/imgs/back-icon.svg" alt="" /></a>
    </div>

    <form action="/estante_web/controllers/edit_livro_controller.php" method="post" enctype="multipart/form-data" id="form-editLivros">
