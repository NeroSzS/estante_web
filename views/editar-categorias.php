...
<main id="conteudo-categoria">
  <div id="modal-categorias">
    <div id="btn-categorias">
      ...
      <a class="btn-back" href="/estante_web/views/categorias.php"><img src="/estante_web/imgs/back-icon.svg" alt="" /></a>
    </div>

    <form action="/estante_web/controllers/edit_categoria_controller.php" method="post" id="form-editCategorias">
