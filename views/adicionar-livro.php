...
<main id="conteudo-livros">
  <div id="modal-livros">
    <div id="btn-livros">
      ...
      <a class="btn-back" href="/estante_web/views/livros.php"><img src="../imgs/back-icon.svg" alt="" /></a>
    </div>

    <form action="/estante_web/controllers/cadastrar_livro_controller.php" method="post" enctype="multipart/form-data" id="form-addLivros">
      <div id="input-add-livro">

        <div id="capaLivro">
          <img src="../imgs/livro01-quarta-capa.jpg" alt="" class="capa_img">
        </div>
